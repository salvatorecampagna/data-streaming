...
class Line:
    """
    Contains Chicago Transit Authority (CTA) Elevated Loop Train ("L") \
    Station Data
    """
    ...
    def __init__(self, color, station_data, num_trains=10):
        ...
        # We must always discount the terminal station at the end of
        # each direction
    ...
    def _get_next_idx(self, curr_index, b_direction, step_size=None):
        """
        Calculates the next station index. Returns next index and
        if it is b direction
        """
